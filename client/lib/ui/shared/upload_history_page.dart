          ...
          : ListView(
              ...
              children: [
                for (final entry in groups.entries) ...[
                  ...
                  for (final it in entry.value) _HistoryRow(item: it, timeText: _fmtTime(it.startedAt), sizeText: _fmtBytes(it.size)),
                ],
              ],
            ),
    );
...
class _HistoryRow extends StatelessWidget {
  ...
  const _HistoryRow({required this.item, required this.timeText, required this.sizeText});
