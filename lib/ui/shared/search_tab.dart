...
class _SearchTabState extends State<SearchTab> {
  ...
  void _onScroll() {
    ...
    if (pos.pixels >= pos.maxScrollExtent - 200 && !_loading && _nextCursor != null) {
      _loadMore();
    }
  }
  ...
  Future<void> _search(String q) async {
    ...
    if (_query.isEmpty || _service == null) {
      setState(() { _items.clear(); _total = 0; _nextCursor = null; });
      return;
    }
          ...
          if (_selecting) ...[
            ...
            if (_query.isNotEmpty)
              IconButton(
                ...
                icon: Icon(Icons.close, size: AppIconSize.lg, color: c.onMuted),
              ),
          ],
        ]),
      ),
